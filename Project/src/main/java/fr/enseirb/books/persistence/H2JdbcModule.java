...
public class H2JdbcModule {
    @Provides
    @Named("restx.jdbc.url") public String jdbcUrl() {
        return "jdbc:h2:./db/books";
    }
    @Provides
    @Named("restx.jdbc.username") public String jdbcUsername() {
        return "sa";
    }
    @Provides
    @Named("restx.jdbc.password") public String jdbcPassword() {
        return "";
    }
